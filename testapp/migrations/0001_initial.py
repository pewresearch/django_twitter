    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('links', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=400), default=list, help_text=b'Links contained in the tweet', null=True, size=None)),
                ('text', models.CharField(max_length=1024, null=True)),
                ('user_mentions_raw', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=280), default=list, null=True, size=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('follower', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='following_details', to='testapp.TwitterProfile')),
                ('following', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='follower_details', to='testapp.TwitterProfile')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='followers',
            field=models.ManyToManyField(related_name='followings', through='testapp.TwitterRelationship', to='testapp.TwitterProfile'),
        ),
        migrations.AddField(
            model_name='twitterprofile',
            name='politician',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='twitter_profiles', to='testapp.Politician'),
        ),
        migrations.AddField(
            model_name='tweet',
            name='hashtags',
        ...
        migrations.AddField(
            model_name='tweet',
            name='place',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tweets', to='testapp.TwitterPlace'),
        ),
        migrations.AddField(
            model_name='tweet',
            name='profile',
        ...
        migrations.AddField(
            ...
            name='politician',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='testapp.Politician'),
        ),
        migrations.AddField(
            model_name='historicaltweet',
            name='in_reply_to_status',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='testapp.Tweet'),
        ),
        migrations.AddField(
            model_name='historicaltweet',
            name='place',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='testapp.TwitterPlace'),
        ),
        migrations.AddField(
            model_name='historicaltweet',
            name='profile',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='testapp.TwitterProfile'),
        ),
        migrations.AddField(
            model_name='historicaltweet',
            name='quoted_status',
        ...
        migrations.AddField(
            ...
            name='profile',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='botometer_scores', to='testapp.TwitterProfile'),
        ),
    ]
