# -*- coding: utf-8 -*-
# Generated by Django 1.11.12 on 2018-06-25 10:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('follower', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='following_details', to='test_app.TwitterProfile')),
                ('following', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='follower_details', to='test_app.TwitterProfile')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='followers',
            field=models.ManyToManyField(related_name='followings', through='test_app.TwitterRelationship', to='test_app.TwitterProfile'),
        ),
        migrations.AddField(
            model_name='twitterprofile',
            name='politician',
